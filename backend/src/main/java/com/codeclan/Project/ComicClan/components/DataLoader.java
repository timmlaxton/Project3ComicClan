...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Comic comic5 = new Comic("Gideon Falls", "Jeff Lamiere", "Andrea Sorrentino", "Dave Stewart", "Steve Wands", publisher3, "Horror", "");
        ...
        Comic comic10 = new Comic("Batman", "Scott Snyder", "Greg Capullo", "FCO Plascencia", "Richard Starkings", publisher2, "Superhero", "");
        ...
        Comic comic19 = new Comic("Bone Parish", "Culle Bunn", "Jonsa Scharf", "Rod Reis", "Ed Dukeshire", publisher7, "Superhero", "");
        comicRepository.save(comic15);
        ...
        Persona persona2 = new Persona("Superman", "Clark Kent", "Superhuman", "Action Comics #1", "");
        personaRepository.save(persona1);

        Persona persona3 = new Persona("Incredible Hulk", "Bruce Banner", "Mental Rage", "The Incredible Hulk #1", "");
        personaRepository.save(persona2);

        Persona persona4 = new Persona("Batman", "Bruce Wayne", "Hunners of money", "Warrior #1", "");
