...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Comic comic24 = new Comic("Detective Comic #27", "Katsuhiro Otomo", "Katsuhiro Otomo ", "Steve Oliff", "Katsuhiro Otomo", publisher4, "Sci-Fi", "/images/Images/Comics/Akira.jpg", "In 1988 the Japanese government drops an atomic bomb on Tokyo after ESP experiments on children go awry. In 2019, 31 years after the nuking of the city, Kaneda, a bike gang leader, tries to save his friend Tetsuo from a secret government project. He battles anti-government activists, greedy politicians, irresponsible scientists and a powerful military leader until Tetsuo's supernatural powers suddenly manifest. A final battle is fought in Tokyo Olympiad exposing the experiment's secrets.");
        comicRepository.save(comic24);

        Comic comic25 = new Comic("Ant-Man #1", "Katsuhiro Otomo", "Katsuhiro Otomo ", "Steve Oliff", "Katsuhiro Otomo", publisher4, "Sci-Fi", "/images/Images/Comics/Akira.jpg", "In 1988 the Japanese government drops an atomic bomb on Tokyo after ESP experiments on children go awry. In 2019, 31 years after the nuking of the city, Kaneda, a bike gang leader, tries to save his friend Tetsuo from a secret government project. He battles anti-government activists, greedy politicians, irresponsible scientists and a powerful military leader until Tetsuo's supernatural powers suddenly manifest. A final battle is fought in Tokyo Olympiad exposing the experiment's secrets.");
        comicRepository.save(comic25);

        Comic comic26 = new Comic("Daredevil #131", "Marv Wolfman", "Bob Brown", "Michele Wolfman", "Joe Rosen", publisher1, "Superhero", "/images/Images/Comics/BEFA.jpg", "Matt is called upon to investigate a slumlord, who turns out to be Heather's father (or at least his company.) He gets sidetracked, however, when an assassin with impeccable aim and a desire for publicity kills a man as an example before drawing Daredevil into a very public fight.");
        comicRepository.save(comic26);

        Comic comic27 = new Comic("CatWoman", "Katsuhiro Otomo", "Katsuhiro Otomo ", "Steve Oliff", "Katsuhiro Otomo", publisher4, "Sci-Fi", "/images/Images/Comics/Akira.jpg", "In 1988 the Japanese government drops an atomic bomb on Tokyo after ESP experiments on children go awry. In 2019, 31 years after the nuking of the city, Kaneda, a bike gang leader, tries to save his friend Tetsuo from a secret government project. He battles anti-government activists, greedy politicians, irresponsible scientists and a powerful military leader until Tetsuo's supernatural powers suddenly manifest. A final battle is fought in Tokyo Olympiad exposing the experiment's secrets.");
        comicRepository.save(comic27);

        Comic comic28 = new Comic("DareDevil", "Katsuhiro Otomo", "Katsuhiro Otomo ", "Steve Oliff", "Katsuhiro Otomo", publisher4, "Sci-Fi", "/images/Images/Comics/Akira.jpg", "In 1988 the Japanese government drops an atomic bomb on Tokyo after ESP experiments on children go awry. In 2019, 31 years after the nuking of the city, Kaneda, a bike gang leader, tries to save his friend Tetsuo from a secret government project. He battles anti-government activists, greedy politicians, irresponsible scientists and a powerful military leader until Tetsuo's supernatural powers suddenly manifest. A final battle is fought in Tokyo Olympiad exposing the experiment's secrets.");
        comicRepository.save(comic28);

        Comic comic29 = new Comic("DrOctopus", "Katsuhiro Otomo", "Katsuhiro Otomo ", "Steve Oliff", "Katsuhiro Otomo", publisher4, "Sci-Fi", "/images/Images/Comics/Akira.jpg", "In 1988 the Japanese government drops an atomic bomb on Tokyo after ESP experiments on children go awry. In 2019, 31 years after the nuking of the city, Kaneda, a bike gang leader, tries to save his friend Tetsuo from a secret government project. He battles anti-government activists, greedy politicians, irresponsible scientists and a powerful military leader until Tetsuo's supernatural powers suddenly manifest. A final battle is fought in Tokyo Olympiad exposing the experiment's secrets.");
        comicRepository.save(comic29);

        Comic comic30 = new Comic("Dr Strange", "Katsuhiro Otomo", "Katsuhiro Otomo ", "Steve Oliff", "Katsuhiro Otomo", publisher4, "Sci-Fi", "/images/Images/Comics/Akira.jpg", "In 1988 the Japanese government drops an atomic bomb on Tokyo after ESP experiments on children go awry. In 2019, 31 years after the nuking of the city, Kaneda, a bike gang leader, tries to save his friend Tetsuo from a secret government project. He battles anti-government activists, greedy politicians, irresponsible scientists and a powerful military leader until Tetsuo's supernatural powers suddenly manifest. A final battle is fought in Tokyo Olympiad exposing the experiment's secrets.");
        comicRepository.save(comic30);

        Comic comic31 = new Comic("Elecktra", "Katsuhiro Otomo", "Katsuhiro Otomo ", "Steve Oliff", "Katsuhiro Otomo", publisher4, "Sci-Fi", "/images/Images/Comics/Akira.jpg", "In 1988 the Japanese government drops an atomic bomb on Tokyo after ESP experiments on children go awry. In 2019, 31 years after the nuking of the city, Kaneda, a bike gang leader, tries to save his friend Tetsuo from a secret government project. He battles anti-government activists, greedy politicians, irresponsible scientists and a powerful military leader until Tetsuo's supernatural powers suddenly manifest. A final battle is fought in Tokyo Olympiad exposing the experiment's secrets.");
        comicRepository.save(comic31);

        Comic comic32 = new Comic("Misty Knight", "Katsuhiro Otomo", "Katsuhiro Otomo ", "Steve Oliff", "Katsuhiro Otomo", publisher4, "Sci-Fi", "/images/Images/Comics/Akira.jpg", "In 1988 the Japanese government drops an atomic bomb on Tokyo after ESP experiments on children go awry. In 2019, 31 years after the nuking of the city, Kaneda, a bike gang leader, tries to save his friend Tetsuo from a secret government project. He battles anti-government activists, greedy politicians, irresponsible scientists and a powerful military leader until Tetsuo's supernatural powers suddenly manifest. A final battle is fought in Tokyo Olympiad exposing the experiment's secrets.");
        comicRepository.save(comic32);

        Comic comic33 = new Comic("SpiderMan", "Katsuhiro Otomo", "Katsuhiro Otomo ", "Steve Oliff", "Katsuhiro Otomo", publisher4, "Sci-Fi", "/images/Images/Comics/Akira.jpg", "In 1988 the Japanese government drops an atomic bomb on Tokyo after ESP experiments on children go awry. In 2019, 31 years after the nuking of the city, Kaneda, a bike gang leader, tries to save his friend Tetsuo from a secret government project. He battles anti-government activists, greedy politicians, irresponsible scientists and a powerful military leader until Tetsuo's supernatural powers suddenly manifest. A final battle is fought in Tokyo Olympiad exposing the experiment's secrets.");
        comicRepository.save(comic33);

        Comic comic34 = new Comic("Thor", "Katsuhiro Otomo", "Katsuhiro Otomo ", "Steve Oliff", "Katsuhiro Otomo", publisher4, "Sci-Fi", "/images/Images/Comics/Akira.jpg", "In 1988 the Japanese government drops an atomic bomb on Tokyo after ESP experiments on children go awry. In 2019, 31 years after the nuking of the city, Kaneda, a bike gang leader, tries to save his friend Tetsuo from a secret government project. He battles anti-government activists, greedy politicians, irresponsible scientists and a powerful military leader until Tetsuo's supernatural powers suddenly manifest. A final battle is fought in Tokyo Olympiad exposing the experiment's secrets.");
        comicRepository.save(comic34);

        Comic comic34 = new Comic("Vulture", "Katsuhiro Otomo", "Katsuhiro Otomo ", "Steve Oliff", "Katsuhiro Otomo", publisher4, "Sci-Fi", "/images/Images/Comics/Akira.jpg", "In 1988 the Japanese government drops an atomic bomb on Tokyo after ESP experiments on children go awry. In 2019, 31 years after the nuking of the city, Kaneda, a bike gang leader, tries to save his friend Tetsuo from a secret government project. He battles anti-government activists, greedy politicians, irresponsible scientists and a powerful military leader until Tetsuo's supernatural powers suddenly manifest. A final battle is fought in Tokyo Olympiad exposing the experiment's secrets.");
        comicRepository.save(comic34);

        Comic comic35 = new Comic("Sensation Comics#1", "Harry G Peter", "Jon L Blummer ", "Jenson Myers", "Nevel Jenkins", publisher2, "Superhero", "/images/Images/Comics/WWFA.jpg", "Wonder Woman was introduced in All Star Comics #8 (December 1941), during the era known to comics historians as the Golden Age of Comic Books. Following this debut, she was featured in Sensation Comics #1 (January 1942), and six months later appeared in her own comic book series (Summer 1942).[3][2] Wonder Woman took her place beside the extant superheroines or antiheroes Fantomah, Black Widow, Invisible Scarlet O'Neil, and Canada's Nelvana of the Northern Lights.");
        ...
        Persona persona9 = new Persona("Dr Octopus", "Otto Gunther Octavius", "Eight Arms and really clever", "The Amazing Spider-Man #3", "/images/Images/Persona/DrOctopus.jpg", "Witness the birth of one of Spider-Man's greatest enemies, the grotesque Dr. Octopus!" );
        personaRepository.save(persona9);

        Persona persona10 = new Persona("Dr Strange", "Dr Steven Strange", "Really mystical", "Warrior #1", "/images/Images/Persona/DrStrange.jpg", "Bruce Wayne, who witnessed the murder of his billionaire parents as a child, swore to avenge their deaths. He trained extensively to achieve mental and physical perfection, mastering martial arts, detective skills, and criminal psychology. Costumed as a bat to prey on the fears of criminals, and utilizing a high-tech arsenal, he became the legendary Batman." );
